...
public class AppConstants {
    ...
    // API
    public static final String TOP_STORIES_API_KEY_HEADER = "api-key";
    public static final String TOP_STORIES_URL_DI_NAME = "top_stories_url";
    public static final String TOP_STORIES_API_KEY_DI_NAME = "top_stories_api_key";
